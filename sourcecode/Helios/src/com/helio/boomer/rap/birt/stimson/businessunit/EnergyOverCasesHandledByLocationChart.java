package com.helio.boomer.rap.birt.stimson.businessunit;
...
public class EnergyOverCasesHandledByLocationChart extends BoomerBirtChart {

	public EnergyOverCasesHandledByLocationChart(String chartTitle) {
		super(chartTitle);
	}
