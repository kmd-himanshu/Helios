package com.helio.boomer.rap.birt.stimson.enterprise;
...
public class BeverageKWhOverEquivalentChart extends BoomerBirtChart {

	public BeverageKWhOverEquivalentChart(String chartTitle) {
		super(chartTitle);
	}
