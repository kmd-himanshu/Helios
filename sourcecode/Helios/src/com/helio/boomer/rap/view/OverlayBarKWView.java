...
public class OverlayBarKWView extends ViewPart {
	
	public static final String ID = "com.helio.boomer.rap.view.overlaybarkwview";
	...
	private Chart createFullDayChart() {
		...
		dayChart.setDescription(TextImpl.create("A new description"));
		...
		adjustFont(xAxisPrimary.getLabel().getCaption().getFont(), 10);
		...
		adjustFont(yAxisPrimary.getLabel().getCaption().getFont(), 10);
