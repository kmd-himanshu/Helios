...
public class EnterpriseNavView extends ViewPart {
	
	public static final String ID = "com.helio.boomer.rap.view.stimson.enterprisenavview";

	private TreeViewer viewer;

	public EnterpriseNavView() {
	}
