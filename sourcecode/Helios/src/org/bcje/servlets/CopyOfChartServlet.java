...
public class CopyOfChartServlet extends HttpServlet
{
			...
			throws IOException, ServletException
	{
		...
		try
		{
			...
			if ( xml != null )
			{
				...
				cm=DataChart.createStockChart();
			}
			if ( cm != null )
			{
				ChartImageManager imageManager = new ChartImageManager(	request, cm, chart.getFormat(),DataForStockChart.getChartData(), null, null,null);
