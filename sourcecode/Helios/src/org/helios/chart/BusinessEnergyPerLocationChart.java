...
public class BusinessEnergyPerLocationChart extends HelioChart{

	public BusinessEnergyPerLocationChart(ChartModel chartModel)
	{
		 if(chartModel.getBuildingIds()!=null && chartModel.getBuildingIds().size()>0)
         {
			...
			try {
				...
				currentValueMap = BusinessUnitReportDAO
						.getEnergyPerLocation(
								chartModel.getLocationIds(), chartModel.getStartSqlDate(),chartModel.getEndSqlDate());
